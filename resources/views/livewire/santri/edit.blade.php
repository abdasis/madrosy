            ...
            <form wire:submit.prevent="simpan">
                <div class="row">
                    <div class="col-md-8">
                        <div class="container">
                            <div class="row gy-3">
                                ...
                                <div class="col-md-4">
                                    <x-form-input type="number" name="jumlah_saudara" wire:model="jumlah_saudara"
                                                  label="Jumlah Saudara" placeholder="Masukan Jumlah Saudara"
                                                  type="number"/>
                                </div>

                                <div class="col-md-4">
                                    <x-form-input type="number" name="anak_ke" label="Anak Ke" wire:model="anak_ke"
                                                  placeholder="Masukan Anak Ke" type="number"/>
                                </div>
                    ...
                    <div class="col-md-3">
                        ...
                        @else
                            <p>Preview Avatar</p>
                            <img src="{{asset($avatar_saat_ini)}}" class="img-fluid img-thumbnail rounded-3" alt="">
                        @endif
                    </div>
                </div>
            </form>
