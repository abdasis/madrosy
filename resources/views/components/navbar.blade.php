        ...
        <div id="scrollbar">
            <div class="container-fluid">
                ...
                <ul class="navbar-nav fw-medium" id="navbar-nav">
                    ...
                    @hasanyrole('Administrator|Guru|BK')
                    <li class="nav-item">
                            ...
                            <ul class="nav nav-sm flex-column">
                                ...
                                <li class="nav-item">
                                    <a href="{{route('pengaturan.data-instansi')}}"
                                       class="nav-link {{menuAktif(route('pengaturan.data-instansi'))}}" data-key="t-chat">
                                        Data
                                        Instansi </a>
                                </li>
                            </ul>
                    ...
                    @hasallroles('Siswa')
                    <li class="nav-item">
                        <a class="nav-link menu-link {{menuAktif(route('log.semua'))}}" href="{{route('tagihan.semua')}}">
