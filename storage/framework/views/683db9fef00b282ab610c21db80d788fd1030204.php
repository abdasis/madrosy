        ...
        <div id="scrollbar">
            <div class="container-fluid">
                ...
                <ul class="navbar-nav fw-medium" id="navbar-nav">
                    ...
                    <?php if(\Spatie\Permission\PermissionServiceProvider::bladeMethodWrapper('hasAllRoles', 'Siswa')): ?>
                    <li class="nav-item">
                        <a class="nav-link menu-link <?php echo e(menuAktif(route('log.semua'))); ?>" href="<?php echo e(route('tagihan.semua')); ?>">
...
<?php /**PATH C:\Users\abdas\Documents\GitHub\madrosy\resources\views/components/navbar.blade.php ENDPATH**/ ?>