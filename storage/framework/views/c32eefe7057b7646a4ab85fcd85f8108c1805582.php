        ...
        <div id="scrollbar">
            <div class="container-fluid">
                ...
                <ul class="navbar-nav fw-medium" id="navbar-nav">
                    ...
                    <?php if(auth()->check() && auth()->user()->hasAnyRole('Kepala Sekolah|Guru|BK')): ?>
                    <li class="menu-title">
                    ...
                    <?php endif; ?>
                    <?php if(auth()->check() && auth()->user()->hasAnyRole('Kepala Sekolah|BK')): ?>
                    <li class="nav-item">
                    ...
                    <?php if(auth()->check() && auth()->user()->hasAnyRole('Kepala Sekolah')): ?>
                    <li class="menu-title">
...
<?php /**PATH /media/aziz/Data Project/GitHub/madrosy/resources/views/components/navbar.blade.php ENDPATH**/ ?>