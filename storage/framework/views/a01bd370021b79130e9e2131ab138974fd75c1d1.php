...
} elseif ($_instance->childHasBeenRendered('l3304534046-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l3304534046-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3304534046-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3304534046-0');
} else {
    $response = \Livewire\Livewire::mount('guru.riwayat-pendidikan-tabel', ['id' => $santri->id]);
    $html = $response->html();
    $_instance->logRenderedChild('l3304534046-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                            </div>
