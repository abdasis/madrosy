                            ...
                            <div class="col col-lg border-end">
                                <div class="mt-3 mt-md-0 py-4 px-3">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            <h2 class="mb-0"><?php echo e($jadual->mapel->nama); ?></h2>
                                        </div>
                                    </div>
                                </div>
                            </div><!-- end col -->
...
<?php $component = ProtoneMedia\LaravelFormComponents\Components\FormInput::resolve(['name' => 'keterangan'] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
