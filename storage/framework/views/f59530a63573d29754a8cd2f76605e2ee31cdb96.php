...
<?php $component = App\View\Components\Modal::resolve(['title' => 'Tambah Mata Pelajaran','modal' => 'tambah-mapel'] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = ProtoneMedia\LaravelFormComponents\Components\FormInput::resolve(['label' => 'Kode Mapel','name' => 'kode'] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
            ...
            <div class="form-group mb-3">
                <?php if (isset($component)) { $__componentOriginalc6dc29918f642c0cf8bf87f6c59d196df1a6e1b4 = $component; } ?>
<?php $component = ProtoneMedia\LaravelFormComponents\Components\FormInput::resolve(['label' => 'Nama Mapel','name' => 'nama'] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('form-input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $constructor = (new ReflectionClass(ProtoneMedia\LaravelFormComponents\Components\FormInput::class))->getConstructor()): ?>
