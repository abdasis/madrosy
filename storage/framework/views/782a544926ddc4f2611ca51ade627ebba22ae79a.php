...
<?php $component = ProtoneMedia\LaravelFormComponents\Components\FormTextarea::resolve(['name' => 'kasus','label' => 'Pelanggaran'] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = ProtoneMedia\LaravelFormComponents\Components\FormInput::resolve(['name' => 'bobot','type' => 'number','label' => 'Bobot Pelanggaran'] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
...
<?php /**PATH /home/aziz/Project/madrosy/resources/views/livewire/pelanggaran/tambah.blade.php ENDPATH**/ ?>