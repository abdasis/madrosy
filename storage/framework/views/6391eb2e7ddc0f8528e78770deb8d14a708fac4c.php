...
<?php foreach($attributes->onlyProps(['column', 'index']) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
<?php $attributes = $attributes->exceptProps(['column', 'index']); ?>
<?php foreach (array_filter((['column', 'index']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
...
<?php if($theme === 'tailwind'): ?>
    <th scope="col" <?php echo e($attributes->merge($customAttributes)
            ...
            ->except('default')); ?>>
        <?php if (! ($component->sortingIsEnabled() && $column->isSortable())): ?>
            <?php echo e($column->getTitle()); ?>

        <?php else: ?>
            <button
                wire:click="sortBy('<?php echo e($column->getColumnSelectName()); ?>')"
            ...
            >
                <span><?php echo e($column->getTitle()); ?></span>
...
<?php endif; ?>
<?php /**PATH C:\Users\abdas\Documents\GitHub\madrosy\resources\views/vendor/livewire-tables/components/table/th.blade.php ENDPATH**/ ?>