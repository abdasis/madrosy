                ...
                <div class="card-body">
                    ...
                    <div class="col-md-6">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <p class="text-muted m-0">: <?php echo e($tagihan->invoice); ?></p>
                                ...
                                <p class="text-muted m-0">: <?php echo e(Str::title($tagihan->status)); ?></p>
                            </div>
                        </div>
                    </div>
...
<?php /**PATH /home/aziz/Project/madrosy/resources/views/livewire/tagihan/detail.blade.php ENDPATH**/ ?>