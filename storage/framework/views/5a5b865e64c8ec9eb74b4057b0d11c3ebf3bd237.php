...
<?php $component = $__env->getContainer()->make(ProtoneMedia\LaravelFormComponents\Components\FormSelect::class, ['name' => ''] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
