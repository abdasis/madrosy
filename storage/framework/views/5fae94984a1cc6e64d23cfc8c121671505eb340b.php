    ...
    <div class="layout-width">
        <div class="navbar-header">
            <div class="d-flex">
                ...
                <div class="navbar-brand-box horizontal-logo">
                    <a href="index.html" class="logo logo-dark">
                        <span class="logo-sm">
                            <img src="<?php echo e(asset('assets/images/logo-sm.png')); ?>" alt="" height="40">
                        </span>
                        <span class="logo-lg">
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown topbar-head-dropdown d-none ms-1 header-item">
                        ...
                        <div data-simplebar style="max-height: 300px;">
                            <div class="p-2">
                                ...
                                <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">
                                    <div class="d-flex align-items-center">
                                        <img src="<?php echo e(asset('assets/images/products/img-1.png')); ?>"
                                ...
                                <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">
                                    <div class="d-flex align-items-center">
                                        <img src="<?php echo e(asset('assets/images/products/img-2.png')); ?>"
                                             class="me-3 rounded-circle avatar-sm p-2 bg-light" alt="user-pic">
                                        <div class="flex-1">
                                            <h6 class="mt-0 mb-1 fs-14">
                    ...
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown"
                        ...
                        <span class="d-flex align-items-center">
                            ...
                            <span class="text-start ms-xl-2">
                                ...
                                <span
                                    class="d-none d-xl-block ms-1 fs-12 text-muted user-name-sub-text"><?php echo e(auth()->user()->roles->first()->name); ?></span>
                            </span>
                        </span>
                    </button>
                    <div class="dropdown-menu dropdown-menu-end">
                        <!-- item-->
                        <h6 class="dropdown-header">Hai, <?php echo e(auth()->user()->name); ?></h6>
                        <a class="dropdown-item" href="<?php echo e(route('profile.auth')); ?>"><i
                        ...
                        <a class="dropdown-item text-danger" href="<?php echo e(route('auth.keluar')); ?>"><i
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\Users\abdas\Documents\GitHub\madrosy\resources\views/components/header.blade.php ENDPATH**/ ?>