            ...
            <ul class="navbar-nav fw-medium" id="navbar-nav">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarDashboards">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="<?php echo e(route('santri.tambah')); ?>" class="nav-link" data-key="t-analytics"> Tambah
                                    Siswa </a>
                            </li>
                        </ul>
                    </div>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="dataGuru">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="<?php echo e(route('guru.semua')); ?>" class="nav-link" data-key="t-analytics"> Semua
                                    Guru </a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a href="<?php echo e(route('riwayat-pendidikan.semua')); ?>" class="nav-link" data-key="t-crm">
                                    Riwayat Sekolah </a>
                            </li>
                        </ul>
                    </div>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="akademik">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="<?php echo e(route('tahun-ajaran.semua')); ?>" class="nav-link" data-key="t-analytics"> Tahun
                                    Ajaran </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('kelas.semua')); ?>" class="nav-link" data-key="t-crm"> Kelas </a>
                            </li>
                            <li class="nav-item">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="presensi">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="<?php echo e(route('presensi.daftar-kelas')); ?>" class="nav-link" data-key="t-calendar">
                                    Absensi </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('presensi.laporan-presensi')); ?>" class="nav-link" data-key="t-chat">
                                    Laporan Presensi </a>
                            </li>
                        </ul>
                    </div>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="konseling">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="<?php echo e(route('konseling.tambah')); ?>" class="nav-link" data-key="t-horizontal">Catat
                                    Konseling</a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('pelanggaran.semua')); ?>" class="nav-link" data-key="t-detached">Jenis
                                    Pelanggaran</a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('konseling.semua')); ?>" class="nav-link" data-key="t-detached">Riwayat
                                    Konseling</a>
                            </li>
                        </ul>
                    </div>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="tagihan">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="<?php echo e(route('kategori-tagihan.semua')); ?>" class="nav-link" data-key="t-calendar">
                                    Kategori Tagihan </a>
                            </li>
                            <li class="nav-item">
